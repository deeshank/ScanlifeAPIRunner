...
public class SignaturGenerator {
    public static void main(String args[]) {
        ...
        // //
        String apiKey = "8776e45b-fbc5-4b15-accc-189bd9d4f57f";
        String secretKey = "zhstGMgDkQLOERYQZ/Yy0vo/c/Tp4qS1ND4QTC0ARnk=";
        String request = null;
        String params = "";
        ...
        try {
            ...
            sortedParamMap.put("codename", "Goran Dobrijevic Business Card");
            ...
            System.out.println("http://api.scanlife.com/api/code/createcode?"
